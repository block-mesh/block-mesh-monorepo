                ...
                <div class="w-80 rounded-lg border-2 border-white bg-gray-800 p-8 shadow-md">
                    <div class="flex justify-center">
                        <a href="https://app.blockmesh.xyz" target="_blank">
                            <img class="w-24 h-24" src="https://imagedelivery.net/3RKw_J_fJQ_4KpJP3_YgXA/ebe1a44f-2f67-44f2-cdec-7f13632b7c00/public"/>
                        </a>
                    </div>
