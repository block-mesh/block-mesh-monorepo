...
pub async fn start_websocket() -> Result<(), JsValue> {
    ...
    // let ws = WebSocket::new("wss://echo.websocket.events/.see")?;
    let ws = WebSocket::new("wss://free.blr2.piesocket.com/v3/1?api_key=LJWXe383XOItoP7uILT0L3MZZ43HAgENkDsd27u4&notify_self=1")?;
