...
pub fn Perks() -> impl IntoView {
    ...
    let has_backback = create_rw_signal(false);
    create_effect(move |_| {
        has_backback.set(window().has_own_property(&JsValue::from_str("backpack")));
    });
                        ...
                        {perks
                            ...
                            .map(|referral| {
                                view! {
                                    <tr>
                                        <TableCell>
                                            {referral.name.clone().to_uppercase()}
                                        </TableCell>
