...
#[template(path = "admin/restore_user_from_archive.html")]
struct RestoreUserFromArchiveTemplate {
...
#[tracing::instrument(name = "restore_user_from_archive_form", skip_all)]
pub async fn handler(State(state): State<Arc<AppState>>) -> impl IntoResponse {
    RestoreUserFromArchiveTemplate {
        ...
        api_path: format!("/api{}", RoutesEnum::Api_RestoreUserFromArchive),
    }
    .into_response()
}
