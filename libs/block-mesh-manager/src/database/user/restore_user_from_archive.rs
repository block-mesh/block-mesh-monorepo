...
pub async fn restore_user_from_archive(
    ...
    Ok(match row.restored_id {
        ...
        None if row.wallet_exists => RestoreUserFromArchiveResult::Conflict,
        None => RestoreUserFromArchiveResult::Conflict,
    })
}
