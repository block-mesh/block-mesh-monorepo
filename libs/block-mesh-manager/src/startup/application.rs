...
impl Application {
    pub async fn build(settings: Settings, app_state: Arc<AppState>, db_pool: PgPool) -> Self {
        ...
        let permissions = "'self' 'unsafe-eval' 'unsafe-inline' 'wasm-unsafe-eval' data: https://fonts.gstatic.com https://fonts.googleapis.com https://rsms.me https://opencollective.com https://cdn.jsdelivr.net https://*.cloudflare.com https://*.blockmesh.xyz https://*.googletagmanager.com https://r2-images.blockmesh.xyz https://*.google-analytics.com chrome-extension://obfhoiefijlolgdmphcekifedagnkfjp ".to_string();
