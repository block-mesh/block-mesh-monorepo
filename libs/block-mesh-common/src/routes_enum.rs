...
pub enum RoutesEnum {
    ...
    Api_CheckToken,
    Api_ActivateExtension,
    Api_EMailViaToken,
    Api_Dashboard,
    Api_GetUserOverallPoints,
    Api_ReportsQueue,
...
impl Display for RoutesEnum {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match &self {
            ...
            RoutesEnum::Api_ActivateExtension => write!(f, "/activate_extension"),
            RoutesEnum::Api_EMailViaToken => write!(f, "/get_email_via_token"),
            RoutesEnum::Api_Dashboard => write!(f, "/dashboard"),
            RoutesEnum::Api_GetUserOverallPoints => write!(f, "/get_user_overall_points"),
