...
<body>
    <div class="container">
        <div class="header">
            <img src="https://perceptron-network.perceptrons.xyz/Logo_only_white.png" alt="Perceptron Network" width="128" height="128" />
            <h1>Perceptron Network - Confirmation Email</h1>
        </div>
        <div class="content">
