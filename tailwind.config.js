...
module.exports = {
    content: [
        ...
        './libs/**/*.{html,js,rs}',
        './libs/block-mesh-manager/templates/tailwind-producer.html'
    ],
    safelist: [
        'hidden',
        'bg-dark-blue',
    ...
    theme: {
        extend: {
            colors: {
                'perceptron-main-black': '#252525',
                'perceptron-secondary-black': '#3B3B3B',
                'perceptron-white': '#F2F2F2',
                'perceptron-orange': '#FF6929',
                'dark-blue': '#0C1120',
                'magenta': '#DA00DB',
                'magenta-1': '#FE49FF',
                'magenta-2': '#E426E6',
