...
export WRITE_DATABASE_URL="postgres://postgres:password@localhost:9559/block-mesh"
export UNLIMITED_DATABASE_URL="postgres://postgres:password@localhost:9559/block-mesh"
...
cargo watch --watch libs --shell "cargo run -p block-mesh-manager --features ssr" | bunyan &
export backend=$!
function cleanup()
{
